...
},{}],"script/localize_ui.mjs":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.localizeUI = localizeUI;
...
},{"../assets/localization/ui.json":"assets/localization/ui.json"}],"script/index.mjs":[function(require,module,exports) {
"use strict";

var _localize_ui = require("./localize_ui.mjs");
...
window.addEventListener("load", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
  var langSelector, topicSelector, defLang;
  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
        langSelector = document.querySelector("#lang_selector");
        langSelector.addEventListener("input", /*#__PURE__*/function () {
          var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  (0, _localize_ui.localizeUI)(event.target.value);
        ...
        topicSelector = document.querySelector("#options");
        topicSelector.addEventListener("input", function () {
          var topics = Array.from(document.querySelector("#options").querySelectorAll(":checked")).map(function (e) {
            return e.value;
          });
        ...
        (0, _localize_ui.localizeUI)(defLang || "en");
...
function loadTopics() {
  var lastPlayed = JSON.parse(localStorage.getItem("topics"));
  if (!lastPlayed) {
    lastPlayed = [0, 1];
    localStorage.setItem("topics", JSON.stringify([0, 1]));
  }
  lastPlayed = lastPlayed.map(function (e) {
    return parseInt(e);
  });
  var topics = Array.from(document.querySelector("#options").querySelectorAll("input"));
...
function formSubmitted(form) {
  ...
  var payload = {
    lang: document.querySelector("#lang_selector").querySelector(":checked").value,
    gameSettings: {
...
},{"./localize_ui.mjs":"script/localize_ui.mjs"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","script/index.mjs"], null)
//# sourceMappingURL=/script.1413b16c.js.map