...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"script/sliders.mjs":[function(require,module,exports) {
...
function handleNumberInput(event) {
  ...
  var spyinput = document.querySelector("#spy_count");
...
function setInputButtonState() {
  var inputs = document.getElementsByClassName("number-input-text-box");
...
function setNumber(event) {
  ...
  var input = document.querySelector("#" + button.dataset.inputId);
  if (input) {
    ...
    if (button.dataset.inputId === "players_count") {
      handleNumberInput({
        target: document.querySelector("#players_count")
      });
    }
  }
}
function setInputValue(input, value) {
  ...
  var parentBox = input.parentElement.getBoundingClientRect();
  input.id = "";
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","script/sliders.mjs"], null)
//# sourceMappingURL=/sliders.5327bccb.js.map